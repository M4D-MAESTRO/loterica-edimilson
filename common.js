...
const Camera = (0,_capacitor_core__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('Camera', {
    web: () => __webpack_require__.e(/*! import() */ "node_modules_capacitor_camera_dist_esm_web_js").then(__webpack_require__.bind(__webpack_require__, /*! ./web */ 29716)).then(m => new m.CameraWeb()),
});
...
/* harmony export */ });
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/core */ 68107);
/* harmony import */ var _definitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./definitions */ 51788);

const Device = (0,_capacitor_core__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('Device', {
    web: () => __webpack_require__.e(/*! import() */ "node_modules_capacitor_device_dist_esm_web_js").then(__webpack_require__.bind(__webpack_require__, /*! ./web */ 36281)).then(m => new m.DeviceWeb()),
});
...
/* harmony export */ });
/* harmony import */ var _helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-1457892a.js */ 96521);
...
/***/ 41400:
/*!***********************************************!*\
  !*** ./src/app/shared/consts/Perfil.const.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PerfilEnum": () => (/* binding */ PerfilEnum)
/* harmony export */ });
var PerfilEnum;
(function (PerfilEnum) {
    PerfilEnum["OPERADOR"] = "OPERADOR";
    PerfilEnum["SUPERVISOR"] = "SUPERVISOR";
    PerfilEnum["GERENTE"] = "GERENTE";
    PerfilEnum["ADMIN"] = "ADMIN";
...
/***/ 92315:
/*!***********************************************!*\
  !*** ./src/app/shared/consts/Status.const.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let PasswordService = class PasswordService {
    ...
    requestReset(email) {
        console.log(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/password/forgot`);
        return this.http.post(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/password/forgot`, {
            email,
        }, {
            responseType: 'json',
        });
    ...
    doReset(token, senha) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpParams()
            .set("token", token);
        return this.http.post(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/password/reset`, {
            senha,
        }, {
            params,
        });
...
let DespesaService = class DespesaService {
    ...
    list() {
        return this.http.get(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/despesa`, {
            responseType: 'json',
        });
    }
    create(newDespesa) {
        return this.http.post(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/despesa`, newDespesa, {
            responseType: 'json',
        });
    }
    update(updatedDespesa, despesa_id) {
        return this.http.put(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/despesa/${despesa_id}`, updatedDespesa, {
            responseType: 'json',
        });
    }
};
...
DespesaService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], DespesaService);
...
/***/ 26285:
/*!************************************************************!*\
  !*** ./src/app/shared/services/produto/produto.service.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let ProdutoService = class ProdutoService {
    ...
    list() {
        return this.http.get(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/produto`, {
            responseType: 'json',
        });
    }
    create(newProduto) {
        return this.http.post(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/produto`, newProduto, {
            responseType: 'json',
        });
    }
    update(updatedProduto, produto_id) {
        console.log(updatedProduto);
        return this.http.put(`${src_config_api_config__WEBPACK_IMPORTED_MODULE_0__.API_CONFIG.baseURL}/produto/${produto_id}`, updatedProduto, {
            responseType: 'json',
        });
    }
};
...
/***/ 81581:
/*!*********************************************!*\
  !*** ./src/app/shared/utils/CameraUtils.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CameraUtils": () => (/* binding */ CameraUtils)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 61855);
/* harmony import */ var _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/filesystem */ 2679);


class CameraUtils {
    static readAsBase64(photo, platform) {
...
CameraUtils.convertBlobToBase64 = (blob) => new Promise((resolve, reject) => {
